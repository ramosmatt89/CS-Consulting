...
const About: React.FC = () => {
  return (
    <section id="sobre" className="py-24 lg:py-32 bg-white relative overflow-hidden">
      {/* Decorative Decal-style Background Text */}
      ...
      <div className="container mx-auto px-6 lg:px-16 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          {/* Image Side - Clean and Minimalist */}
          <div className="lg:w-1/2 relative group reveal">
            <div className="relative z-10 rounded-[2rem] overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.12)] border-4 border-white transition-all duration-700 group-hover:scale-[1.02] group-hover:shadow-[0_40px_80px_rgba(0,0,0,0.2)]">
              <img 
